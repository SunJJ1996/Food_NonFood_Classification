...
model_names = [
    ...
    'resnet152']
Pick_model = 'densenet161'
parser = argparse.ArgumentParser(description='PyTorch ImageNet Training')
# parser.add_argument('data', metavar='DIR', default='Food_classification', help='path to dataset')
parser.add_argument('-a', '--arch', metavar='ARCH', default=Pick_model, choices=model_names,
...
def main():
    ...
    # Data loading
    train_loader, val_loader = data_loader('/data/sjj/Food_classification', args.batch_size, args.workers, args.pin_memory)
